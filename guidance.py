...
# Initial coordinates
starting_latitude = 34.0000  # starting latitude
starting_longitude = -117.0000  # starting longitude
...
try:
    while True:
        ...
        print(f"Pitch: {angle_x:.2f}° | Roll: {angle_y:.2f}° | Altitude: {altitude:.2f} m | Starting Location: ({starting_latitude}, {starting_longitude})")

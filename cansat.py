...
def main_loop():
    ...
    try:
        p0 = bmp.read_pressure()
        if p0 is not None and p0 > 100.0:
    ...
    try:
        while True:
            ...
            if pressure is not None and pressure > 100.0:
                altitude = pressure_to_altitude(pressure, p0=sea_level_pressure)
            else:
                altitude = 0.0
